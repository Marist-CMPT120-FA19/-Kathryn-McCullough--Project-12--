...
#I have literally spent at least 10 hours on this program and I sitll can't get..
#..it to run properly or all the way through
    ...
    def withdraw(self):
        ...
        if acct == 'c':
            if 0<= amt <= self.cust.get_cbal():
                ...
                print ('Nice try,sucker. You can\'t withdraw negative funds.')
            else:
            ...
            if 0 <= amt <= self.cust.get_sbal():
                ...
                print ('Nice try. You can\'t withdraw negative funds.')
            else:
                print('Insufficient funds')
        self.again()
    ...
    def transfer(self):
        ...
        if tfr == 'cts':
            ...
            if 0 <= amt <= self.cust.get_sbal():
                ...
                print('Nice try, sucker. You cant\'t withdraw negaitve funds.')
            else:
